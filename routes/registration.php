...
Route::prefix("onboarding/")
	...
	Route::post('request', [OnboardingRequestController::class, 'createRequest']);
	Route::get('request/student', [OnboardingInfosController::class, 'studentForm'])->name("onboarding.student");
